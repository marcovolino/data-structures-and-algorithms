...
title: Strings
---
A **string** is a sequence of characters used to represent text, which can include letters, numbers, symbols, and spaces. Strings are typically defined by enclosing a series of characters in quotes e.g., "hello". Strings are one of the most commonly used data structures in programming, used for tasks like displaying messages, processing input, or manipulating text. Under the hood, a string is often implemented as an [array](/data-structures/arrays) of characters with a special end marker or length field, see figure below. In some languages, such as python, strings are immutable, meaning their contents cannot be changed after creation. 




![Image of a String](../image/string.png)
...
Finally a demonstration of finding a substring within a larger string using the `find()` function of the string class.
```c++
// initialise strings
